# ZonaWa - Project Vision

## Purpose
ZonaWa es una plataforma SaaS multi-tenant diseñada para automatizar y administrar la atención al cliente en WhatsApp utilizando múltiples proveedores de Inteligencia Artificial (IA). Permite conectar números de WhatsApp (vía Evolution API) y asociar cada número a un agente de IA personalizado.
...
## Requirements
### Requirement: Control Multi-Agente y SaaS Multi-tenant
La plataforma SHALL permitir que cada número trabaje con un proveedor y modelo de IA diferente de manera independiente.

#### Scenario: Visualización del Panel y Gestión de Límites
- **WHEN** Un usuario inicia sesión en la plataforma y visualiza el panel
- **THEN** Se muestran las métricas de consumo de tokens y los límites de uso correspondientes (máximo 6 números y 5 bots activos).
