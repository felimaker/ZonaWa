# ZonaWa - AI Traffic Monitoring

## Purpose
Monitorear, auditar e inspeccionar en tiempo real las peticiones y respuestas cursadas hacia los diferentes proveedores de Inteligencia Artificial (OpenAI, Claude, Gemini, Groq), calculando los consumos de tokens reales y costos asociados de forma consolidada.
