# ZonaWa - Frontend Structure

## Purpose
Describir la estructura modular de directorios en React, el sistema de diseño premium (glassmorphism) y las reglas de diseño responsivo (breakpoints para móvil, tablet y desktop).
...
## Requirements
### Requirement: Diseño Responsivo Multipantalla
La interfaz de usuario SHALL adaptarse responsivamente ocultando el sidebar en pantallas móviles (<640px) y mostrando una barra de navegación inferior fija.
